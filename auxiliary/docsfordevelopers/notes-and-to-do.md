...
* Provide a 'download scenario' button, which downloads code that reproduces a given scenario. To that end, finish implementing download_code in develop branch, once it works move over to main. 

Download_code related:
