...
I assume you have [R](https://www.r-project.org/) installed. I also highly recommend some IDE like RStudio, Positron or VS Code. After having opened R, you can install the package from CRAN by typing the following into the R console (the bottom left window if you are using RStudio):
