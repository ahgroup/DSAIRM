...
I assume you have [R](https://www.r-project.org/) installed. I also highly recommend [RStudio](https://posit.co/download/rstudio-desktop/), though it is not required. After having opened R/Rstudio, you can install the package from CRAN by typing the following into the R console (the bottom left window if you are using RStudio):
