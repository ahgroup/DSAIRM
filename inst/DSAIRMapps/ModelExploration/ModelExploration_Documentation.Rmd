...
* You could for instance write your own function with that loops over some parameter and for each parameter calls one of the model simulator, e.g. `simulate_basicbacteria.R` or `simulate_Basic_Virus_model_ode.R` or `simulate_virusandIR.R`. See the package vignette for an example.
