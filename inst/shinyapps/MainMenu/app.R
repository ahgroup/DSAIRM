...
ui <- fluidPage(
  ...
  p('You should start with the "Basic Bacteria Model" app and read all its instruction tabs since they contain information relevant for all apps.',class='infotext', align="left"),
