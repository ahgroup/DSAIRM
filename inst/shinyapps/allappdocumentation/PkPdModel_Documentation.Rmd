...
* Appreciate the impact different drug Pk/Pd can have on result
* 
...
$$C =  r_C t_n e^{-d_C t_n}$$ 
Where *t~n~* is the time since the last dose was given. Prior to treatment start, i.e. (t<txstart), there is no drug and *C=0*.
