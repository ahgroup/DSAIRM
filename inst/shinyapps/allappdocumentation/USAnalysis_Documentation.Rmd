...
* Now change the random number seed to a different value, run again. You should see results slighly changed.
...
###Task 2: 
* Recall the model and its behavior. If you can't, revisit the "Basic Bacteria" app and go through it. Use your understanding of the model to predict what happens if you increase both lower and upper bound for the bacteria carrying capacity, _Bmax_. Which of the outcomes do you expect to change, and in which direction?
* Test your assumption my increasing both lower and upper bound for _Bmax_ by 2 orders of magnitude and run the simulation.
