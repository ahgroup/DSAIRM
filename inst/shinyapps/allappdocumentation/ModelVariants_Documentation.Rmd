...
_For the tasks below, it is assumed that the model is ruin in units of days_
...
###Task 2: 
* Let's explore different mechanisms for the innate response. Keep initial level of innate response at 0, but set innate production and removal rate to 1. Set all inate growth parameters (the _f~i~_) and all innate actions (the _k~1~_ - _k~3~_) to 0. 
