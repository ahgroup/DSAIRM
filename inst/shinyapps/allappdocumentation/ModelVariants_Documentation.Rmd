...
2. Infected cells die at rate *d_I_* and produce virus at rate _p_.
...
4. In the absence of virus, the inate response is produced at a rate *p_F* and removed at a rate *d_F_*. In the presence of virus, the innate response additionally grows according to 3 alternative model formulations. 1) Proportional to virus at rate *f_1_* and saturating at a maximum level **F_max_**. 2) Proportional to virus at rate *f_2*, with a growth rate saturating at high levels of virus, determined by the saturation constant *s_V*, 3) Proportional to both virus and infected cells at rate *f_3_*, with a growth rate saturating at high levels of virus and infected cells, determined by the saturation constant *s_V*.
