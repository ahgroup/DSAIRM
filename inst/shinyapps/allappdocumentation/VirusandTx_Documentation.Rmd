...
###Task 5: 
* Now start at steady state, run the simulation for 30 days and turn on treatment at 10 days. Try different strengths of treatment efficacy (values for parameteres _f_ and _e_). It might be useful to plot the y-axis on a logarithmic scale to better see the virus kinetics.
...
###Task 7: 
* Run the simulations from task 5 for a longer time and observe what the different variables do.
