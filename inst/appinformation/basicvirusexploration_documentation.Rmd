...
out_records = c("Value for p when Isteady ~= Usteady, 96 samples, p to vary from 1 to 20 on a linear scale (Hint: use plotly to zoom-in)", "Number of values for p that are > 5 with 96 samples, p to vary from 1 to 20 on a linear scale", "Number of values for p that are > 5 with 96 samples, p to vary from 1 to 20 on a log scale")
...
out_records = c("Using equation, Vsteady when b = 6.16e-6", "Using plotly output, Vsteady when b ~= 6.16e-6")
