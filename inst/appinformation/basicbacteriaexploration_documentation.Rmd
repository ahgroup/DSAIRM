...
As mentioned, the underlying model is the continuous-time, ODE version of the model from the  ___Basic Bacteria Model___ app. Details can be found there. For ease of reference, the flow diagram and the equations of the continuous model are shown again here:
