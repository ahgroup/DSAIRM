...
#########################
tid = 1
tasktext = "* Set numbers for initial uninfected cells, infected cells and virus to U=100000, I=0, and V=1.
...
#########################
tid = tid + 1
tasktext = "* Play around with the samples to run, i.e. the number of different parameter values. The higher the number, the more often the simulation runs, the longer it takes and the more detailed the results are. 
