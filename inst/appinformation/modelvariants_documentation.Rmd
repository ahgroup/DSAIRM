...
#########################
tid = tid + 1
tasktext = "Now explore what happens when you have non-zero _k~i~_. You'll find that the action of the innate response impacts the other variables, which in turn can impact further innate activation. Some of the resulting dynamics can get complex. Pay attention to how different processes of innate activation and innate action do or don't produce different overall dynamics."
nrec = 1 # number of items to record
out_records = c("Something")
out_types = rep("Rounded_Integer",nrec)
out_notes = rep("Report the rounded integer",nrec)
