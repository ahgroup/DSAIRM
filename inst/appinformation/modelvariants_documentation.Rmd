...
### Learning Objectives
* Explore structural uncertainty for model parameterization
...
* The adaptive immune response decays at a rate *d~A~*.
...
_For the tasks below, it is assumed that the model is run in units of days._
