...
#########################
tid = 1
tasktext = "Take a look at the inputs and outputs for the app. It's similar to the 'Basic Fitting' app (which you should do before this one). Each model has 3 parameters that are being estimated, the best fit estimates are shown under the figure, together with the SSR and AICc. Switch to model 2, run and compare how it differs from model 1."
