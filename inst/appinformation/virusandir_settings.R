############################################################
#This is a file for the Virus and immune response App
...
appsettings$apptitle = "Virus and immune response model"

#name of underlying simulation function(s) to be used in the app
#must be provided
appsettings$simfunction = 'simulate_virusandir_ode'
