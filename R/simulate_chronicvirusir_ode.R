...
simulate_chronicvirusir_ode <- function(U = 1e+05, I = 0, V = 1, F = 1, T = 1, n = 0, dU = 0, dI = 1, dV = 2, b = 2e-05, p = 5, g = 1, rF = 0.001, dF = 1, kF = 0.01, rT = 0.001, dT = 1, kT = 0.01, tstart = 0, tfinal = 100, dt = 0.1)
{
  ##############################
